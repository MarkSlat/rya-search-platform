...
lengths_of_stay = [2, 3, 4]  # Length of stay in days (e.g., 3 days, 4 days)
blacklist_countries = ['Ireland', 'United Kingdom']  # Exclude destinations in Ireland and Spain

# Run the query
result = GraphRepository(driver).query_flights(origin_airports, r1_dates, r2_dates, lengths_of_stay, blacklist_countries)
